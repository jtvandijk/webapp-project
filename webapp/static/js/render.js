...
function renderNotFound(surname) {
  ...
  notFound.innerHTML = 'Unfortunately, <strong>'+surname.toUpperCase()+'</strong> is not in our database. Try searching for a different surname!';
...
function renderHTML(surname) {
  ...
  mapLegend.className = 'card-footer small text-muted text-justify p-2';
  mapLegend.innerHTML = 'The heatmap shows the areas with the highest densities of surname <b>'+surname.toUpperCase()+'</b>. Use the slider bar to show the heatmap for other available years.';

  parLegend.id = 'parLegend';
  parLegend.className = 'card-footer small text-muted text-justify p-2';
  ...
  msoaLegend.className = 'card-footer small text-muted text-justify p-2';
...
//render forenames
function renderForenames(ffh,fmh,fmc,ffc) {
  ...
  foreHistLegend.className = 'card-footer small text-muted text-justify p-2';
  foreHistLegend.innerHTML = 'Forenames with highest frequencies for all residents over the period 1851-1911.';
  foreContLegend.id = 'foreContLegend';
  foreContLegend.className = 'card-footer small text-muted text-justify p-2';
  foreContLegend.innerHTML = 'Forenames with highest frequencies for adult residents over the period 1997-2016.';;
