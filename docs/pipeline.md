...
run against a real stage 4/5 output. How to run it, step by step: the end of how-to-build-the-dataset.md.
...
The old run made 1.2 million maps over several days. The real run has 43,093 names and 15 periods, so at
most about 646,000 maps; the threshold leaves out most of the possible ones, and about 365,000 were built (the Scotland
rule reuses 1901's map for 1911 and 1921 instead of building one).
