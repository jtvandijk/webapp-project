...
| 5 | **Facts need at least 5 people** | The most common group, and every neighbourhood, parish or forename listed, must have at least **5** bearers | Otherwise it is left out. A source only gives facts to a surname with 100 or more bearers in that source in some year: register facts need 100 register bearers in a year, the historic parishes and forenames need 100 census bearers in a census year. |
