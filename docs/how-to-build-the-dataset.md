...
- *1921 has no id 0.* People who were not in a parish have no parish id at all (NULL); stage 1 counts them with the id-0 people of the other years (`config.CENSUS_NULL_PARISH_IS_NONE`).
