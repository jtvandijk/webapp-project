...
function populateTable(years,surname,freqs) {
  ...
  if (years[0] == 1851) {
    caption.innerHTML = 'Number of bearers of <strong>'+surname.toUpperCase()+'</strong> in our database (1911 counts exclude Scotland).';
  } else {
    caption.innerHTML = 'Number of adult bearers of <strong>'+surname.toUpperCase()+'</strong> in our database.';
  };
